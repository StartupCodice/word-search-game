...
export default function InfinitoPro({ navigation, rows = 12, cols = 12 }) {
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "NÓS", found: false },
        { name: "VIGO", found: false },
        { name: "DUNA", found: false },
        { name: "BOLO", found: false },
        { name: "FACA", found: false },
        { name: "FIO", found: false },
        { name: "PATO", found: false },
        { name: "SURF", found: false },
        { name: "REI", found: false },
        { name: "POLO", found: false },
        { name: "BOLA", found: false },
        { name: "KIT", found: false },
        { name: "REDE", found: false },
        { name: "RISO", found: false },
        { name: "CARO", found: false },
        { name: "GEMA", found: false },
        { name: "VILA", found: false },
        { name: "TIPO", found: false },
        { name: "TOMA", found: false },
        { name: "BALA", found: false },
        { name: "PAUSA", found: false },
        { name: "GRITO", found: false },
        { name: "SORRIR", found: false },
        { name: "LIMPO", found: false },
        { name: "SONO", found: false },
        { name: "FOME", found: false },
        { name: "MACIO", found: false },
        { name: "VERDE", found: false },
        { name: "ÁGUA", found: false },
        { name: "LARANJA", found: false },
        { name: "FELIZ", found: false },
        { name: "RÁPIDO", found: false },
        { name: "CAVALO", found: false },
        { name: "MÚSICA", found: false },
        { name: "PRAIA", found: false },
        { name: "BONITO", found: false },
        { name: "CINZA", found: false },
        { name: "DOENTE", found: false },
        { name: "BRINCO", found: false },
        { name: "FUTURO", found: false }
      ];
