...
export default function Presentes({ navigation }) {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        const palavrasOriginais = [
            { name: 'LIVROS', found: false },
            { name: 'PERFUMES', found: false },
            { name: 'JOIAS', found: false },
            { name: 'ARTIGOS', found: false },
            { name: 'RELOGIOS', found: false },
            { name: 'ROUPAS', found: false },
          ];
