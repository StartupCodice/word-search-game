      ...
      <TouchableOpacity >
          ...
          <View style={styles.container}>
            <View style={styles.containerMode}>
              <View >
                <TouchableOpacity style={styles.estiloButton} onPress={() => navigation.navigate("Presentes")}>
              ...
              <View >
                <TouchableOpacity style={styles.estiloButton} onPress={() => navigation.navigate("Decoracoes")}>
              ...
              <View >
                <TouchableOpacity style={styles.estiloButton} onPress={() => navigation.navigate("Alimentos")}>
              ...
              <View >
                <TouchableOpacity style={styles.estiloButton} onPress={() => navigation.navigate("Personagens")}>
