      ...
      <ImageBackground source={require('../../../assets/temanatal.jpg')} style={styles.imageBackground}> 
          ...
          <View style={styles.container}>
            <View style={styles.containerMode}>
              <View >
                <TouchableOpacity style={styles.ButtonEstilo} onPress={() => navigation.navigate("PresentesMedio")}>
              ...
              <View >
                <TouchableOpacity style={styles.ButtonEstilo} onPress={() => navigation.navigate("DecoracoesMedio")}>
              ...
              <View >
                <TouchableOpacity style={styles.ButtonEstilo} onPress={() => navigation.navigate("AlimentosMedio")}>
              ...
              <View >
                <TouchableOpacity style={styles.ButtonEstilo} onPress={() => navigation.navigate("PersonagensMedio")}>
