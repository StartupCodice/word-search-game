...
export default function BebidasMedio({ navigation, rows = 8, cols = 8 }) {
  const { bebidas, addBebidas } = NiveisMedio();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "CAFÉ", found: false },
        { name: "LEITE", found: false },
        { name: "COCO", found: false },
        { name: "VINHO", found: false },
        { name: "SUCO", found: false },
        { name: "CERVE", found: false },
        { name: "VODKA", found: false },
        { name: "RUM", found: false },
        { name: "TEQUILA", found: false },
        { name: "COCA", found: false },
        { name: "SPRITE", found: false },
        { name: "FROZEN", found: false },
        { name: "GIM", found: false },
        { name: "SODA", found: false },
        { name: "WHISKY", found: false },
        { name: "CIDRA", found: false },
        { name: "MATE", found: false },
        { name: "LICOR", found: false },
      ];
