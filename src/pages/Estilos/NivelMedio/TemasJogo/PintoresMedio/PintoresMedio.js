...
export default function PintoresMedio({ navigation, rows = 8, cols = 8 }) {
  const { 
    pintores, 
    addPintores,
  } = NiveisMedio();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        { name: 'DALI', found: false },
        { name: 'GOGH', found: false },
        { name: 'MONET', found: false },
        { name: 'RENOIR', found: false },
        { name: 'CEZANE', found: false },
        { name: 'POLLOC', found: false },
        { name: 'KANDIN', found: false },
        { name: 'MUNCH', found: false },
        { name: 'GOYA', found: false },
        { name: 'WARHOL', found: false },
        { name: 'VINCI', found: false },
        { name: 'FRIDA', found: false },
        { name: 'HIRSCH', found: false },
        { name: 'RAUSCH', found: false },
        { name: 'OKEEFF', found: false },
        { name: 'HOPPER', found: false },
        { name: 'CHAGAL', found: false },
        { name: 'MAGRIT', found: false },
        { name: 'ROTHKO', found: false },
        { name: 'DIEGO', found: false },
      ];
...
const onHandlerStateChange = (event, item) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal isVisible={isModalVisible} onBackdropPress={closseModal} style={styles.modalContainer2}>
        <View style={styles.modalContainer}>
