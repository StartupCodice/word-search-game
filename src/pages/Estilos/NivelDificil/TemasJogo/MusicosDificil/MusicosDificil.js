...
export default function MusicosDificil({ navigation, rows = 10, cols = 10 }) {
  const { musicos, addMusicos } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        { name: "ADELE", found: false },
        { name: "BEETH", found: false },
        { name: "CHICO", found: false },
        { name: "DRAKE", found: false },
        { name: "ELTON", found: false },
        { name: "FELIX", found: false },
        { name: "GLORIA", found: false },
        { name: "HANKS", found: false },
        { name: "IGOR", found: false },
        { name: "JOVEM", found: false },
        { name: "KATY", found: false },
        { name: "LORDE", found: false },
        { name: "MICKY", found: false },
        { name: "NUNES", found: false },
        { name: "OZZY", found: false },
        { name: "PINK", found: false },
        { name: "QUINN", found: false },
        { name: "ROGER", found: false },
        { name: "SIA", found: false },
