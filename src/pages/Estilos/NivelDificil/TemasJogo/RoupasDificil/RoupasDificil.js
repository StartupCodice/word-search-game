...
export default function RoupasDificil({ navigation, rows = 10, cols = 10 }) {
  const { roupas, addRoupas } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "CALÇA", found: false },
        { name: "SAIA", found: false },
        { name: "MEIA", found: false },
        { name: "BONÉ", found: false },
        { name: "GRAVY", found: false },
        { name: "LENÇO", found: false },
        { name: "CAPA", found: false },
        { name: "TÊNIS", found: false },
        { name: "CINTO", found: false },
        { name: "COLETE", found: false },
        { name: "ANEL", found: false },
        { name: "JEANS", found: false },
        { name: "LUVAS", found: false },
        { name: "SHORT", found: false },
        { name: "REGATA", found: false },
        { name: "COLAR", found: false },
        { name: "TOUCA", found: false },
