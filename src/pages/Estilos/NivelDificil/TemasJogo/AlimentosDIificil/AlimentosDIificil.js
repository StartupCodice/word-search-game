...
export default function AlimentosDificil({ navigation, rows = 10, cols = 10 }) {
  const { alimentos, addAlimento } = NiveisDificil();
  ...
  const fetchData = () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "SOPA", found: false },
        { name: "MEL", found: false },
        { name: "CAJU", found: false },
        { name: "AÇAI", found: false },
        { name: "ALHO", found: false },
        { name: "FIGO", found: false },
        { name: "Soja", found: false },
        { name: "UVA", found: false },
        { name: "TOFU", found: false },
        { name: "Lima", found: false },
        { name: "CHÁ", found: false },
        { name: "BIFE", found: false },
        { name: "KIWI", found: false },
        { name: "BOLO", found: false },
        { name: "SIRI", found: false },
        { name: "LULA", found: false },
        { name: "PERA", found: false },
        { name: "NABO", found: false },
        { name: "TACO", found: false },
        { name: "Arroz", found: false },
        { name: "Feijão", found: false },
        { name: "Milho", found: false },
        { name: "Batata", found: false },
        { name: "Cenoura", found: false },
        { name: "Tomate", found: false },
        { name: "Alface", found: false },
        { name: "Banana", found: false },
        { name: "Maçã", found: false },
        { name: "Uva", found: false },
        { name: "Carne", found: false },
        { name: "Peixe", found: false },
        { name: "Frango", found: false },
        { name: "Ovo", found: false },
        { name: "Queijo", found: false },
        { name: "Iogurte", found: false },
