...
export default function NaturezaDificil({ navigation, rows = 10, cols = 10 }) {
  const { natureza, addNatureza } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "TRONCO", found: false },
        { name: "LAGO", found: false },
        { name: "MAR", found: false },
        { name: "SOLAR", found: false },
        { name: "FLOR", found: false },
        { name: "SOL", found: false },
        { name: "LUAR", found: false },
        { name: "PRAIA", found: false },
        { name: "NEVE", found: false },
        { name: "CEU", found: false },
        { name: "BOSQUE", found: false },
        { name: "PEDRA", found: false },
        { name: "NUVENS", found: false },
        { name: "CORAL", found: false },
        { name: "FLOR", found: false },
        { name: "LAMA", found: false },
        { name: "RIACHO", found: false },
        { name: "GROTAS", found: false },
      ];
