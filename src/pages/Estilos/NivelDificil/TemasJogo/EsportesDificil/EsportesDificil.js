...
export default function EsportesDificil({ navigation, rows = 10, cols = 10 }) {
  const { esportes, addEsportes } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        { name: "GOLFE", found: false },
        { name: "XADREZ", found: false },
        { name: "CAMPO", found: false },
        { name: "NADAR", found: false },
        { name: "SKATE", found: false },
        { name: "SURFE", found: false },
        { name: "BOXE", found: false },
        ...
        { name: "ESQUI", found: false },
        { name: "CORRER", found: false },
