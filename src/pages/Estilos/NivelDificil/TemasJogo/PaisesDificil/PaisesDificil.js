...
export default function PaisesDificil({ navigation, rows = 10, cols = 10 }) {
  const { paises, addPaises } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "Síria", found: false },
        { name: "Quênia", found: false },
        { name: "Ruanda", found: false },
        { name: "Uganda", found: false },
        { name: "Zâmbia", found: false },
        { name: "Vietnã", found: false },
        { name: "Líbano", found: false },
        { name: "Irã", found: false },
        { name: "Iraque", found: false }
      ];
