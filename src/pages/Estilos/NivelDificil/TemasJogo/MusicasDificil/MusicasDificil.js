...
export default function MusicasDificil({ navigation, rows = 10, cols = 10 }) {
  const { musicas, addMusicas } = NiveisDificil();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        { name: "BLUES", found: false },
        { name: "JAZZ", found: false },
        { name: "ROCK", found: false },
        { name: "POP", found: false },
        { name: "RAP", found: false },
        { name: "REGGAE", found: false },
        { name: "FOLK", found: false },
        { name: "SALSA", found: false },
        { name: "SAMBA", found: false },
        { name: "R&B", found: false },
        { name: "GOSPEL", found: false },
        { name: "PUNK", found: false },
        { name: "METAL", found: false },
        { name: "DISCO", found: false },
        { name: "FUNK", found: false },
        { name: "SOUL", found: false },
        { name: "FADO", found: false },
        { name: "RAGA", found: false },
        { name: "TANGO", found: false },
      ];
