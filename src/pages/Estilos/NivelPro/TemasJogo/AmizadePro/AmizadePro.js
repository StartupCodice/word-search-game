...
export default function AmizadePro({ navigation, rows = 12, cols = 12 }) {
  const { amizade, addAmizade } = NiveisPro();
  ...
  const fetchData = async () => {
    try {
      ...
      { name: "Carinho", found: false },
      { name: "Apoio", found: false },
      { name: "Alegria", found: false },
      { name: "Respeito", found: false },
      { name: "Amigável", found: false },
      { name: "Lealdade", found: false },
      { name: "Confiança", found: false },
      { name: "Empatia", found: false },
      { name: "Cuidado", found: false },
      { name: "Afeto", found: false },
      { name: "Sorriso", found: false },
      { name: "Amor", found: false },
      { name: "Gratidão", found: false },
      { name: "Fé", found: false },
      { name: "Aconchego", found: false },
      { name: "Companhia", found: false },
      { name: "União", found: false },
      { name: "Ajuda", found: false },
      { name: "Amizade", found: false },
      { name: "Diversão", found: false },
      { name: "Generoso", found: false },
      { name: "Ternura", found: false },
      { name: "Paciência", found: false },
      { name: "Tranquil", found: false },
      { name: "Harmonia", found: false },
      { name: "Confidente", found: false },
      { name: "Reciproco", found: false },
      { name: "Alegre", found: false },
      { name: "Troca", found: false },
      { name: "Felicidade", found: false },
      { name: "Apóio", found: false },
      { name: "Unidos", found: false },
      { name: "Solidári", found: false },
      { name: "Segurança", found: false },
      { name: "Parceria", found: false }
      ];
