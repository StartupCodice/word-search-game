...
export default function DocesPro({ navigation, rows = 12, cols = 12 }) {
  const { doces, addDoces } = NiveisPro();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        { name: "PAVE", found: false },
        { name: "DOCE", found: false },
        { name: "CHOCO", found: false },
        { name: "PUDIM", found: false },
        { name: "MEL", found: false },
        { name: "FINI", found: false },
        { name: "MAXI", found: false },
        { name: "CREME", found: false },
        { name: "MUFFI", found: false },
        { name: "CAKE", found: false },
        { name: "MOUSSE", found: false },
        { name: "COCADA", found: false },
        { name: "PALHA", found: false },
        { name: "DANONE", found: false },
        { name: "TORTA", found: false },
        { name: "Caramelo", found: false },
        { name: "Chocolate", found: false },
        { name: "Gelatina", found: false },
        { name: "Marshmelo", found: false },
        { name: "Cupcake", found: false },
        { name: "Pirulito", found: false },
        { name: "Sorvete", found: false },
        { name: "Bombom", found: false },
        { name: "Açúcar", found: false },
        { name: "Bala", found: false },
        { name: "Torta", found: false },
        { name: "Brownie", found: false },
        { name: "Tâmaras", found: false },
        { name: "Paçoca", found: false },
        { name: "Mousse", found: false },
        { name: "Geleia", found: false },
        { name: "Melado", found: false },
        { name: "Trufa", found: false },
        { name: "Churros", found: false },
        { name: "Rapadura", found: false },
        { name: "Macaron", found: false },
        { name: "Brigadeiro", found: false },
        { name: "Biscoito", found: false },
        { name: "Muffin", found: false },
        { name: "Marzipan", found: false },
        { name: "Fondue", found: false },
        { name: "Goiabada", found: false },
        { name: "Milkshake", found: false },
        { name: "Alfajor", found: false },
        { name: "Goma", found: false },
        { name: "Pastel", found: false },
        { name: "Banana", found: false },
        { name: "Docinho", found: false },
        { name: "Picolé", found: false },
        { name: "Quindim", found: false },
        { name: "Waffle", found: false },
        { name: "Geléia", found: false },
        { name: "Chiclete", found: false },
        { name: "Cocada", found: false }
      ];
