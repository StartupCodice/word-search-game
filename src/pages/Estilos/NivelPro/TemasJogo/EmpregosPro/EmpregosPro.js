...
export default function EmpregosPro({ navigation, rows = 12, cols = 12 }) {
  const { empregos, addEmpregos } = NiveisPro();
  ...
  const fetchData = async () => {
    try {
      const palavrasOriginais = [
        ...
        { name: "Professor", found: false },
        { name: "Advogado", found: false },
        { name: "Músico", found: false },
        { name: "Escritor", found: false },
        { name: "Cantor", found: false },
        { name: "Dentista", found: false },
        { name: "Cobrador", found: false },
        { name: "Vendedor", found: false },
        { name: "Jardineiro", found: false },
        { name: "Garçom", found: false },
        { name: "Programador", found: false },
        { name: "Piloto", found: false },
        { name: "Motorista", found: false },
        { name: "Técnico", found: false },
        { name: "Artista", found: false },
        { name: "Costureiro", found: false },
        { name: "Policial", found: false },
        { name: "Bombeiro", found: false },
        { name: "Gerente", found: false },
        { name: "Analista", found: false },
        { name: "Designer", found: false },
        { name: "Soldador", found: false },
        { name: "Mecânico", found: false },
        { name: "Porteiro", found: false },
        { name: "Campeão", found: false },
        { name: "Cozinheiro", found: false },
        { name: "Padeiro", found: false },
        { name: "Ferreiro", found: false },
        { name: "Agrônomo", found: false },
        { name: "Jogador", found: false }
      ];
